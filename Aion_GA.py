...
class AionTriggerHelper(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("Aion Helper Pro - Fixed Pointers")
    ...
    def execute_logic(self):
        ...
        try:
            ...
            self.last_trigger_val = data.get("트리거 값", -1)
        except: pass
